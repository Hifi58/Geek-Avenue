...
<?php
$sql = "SELECT * FROM annonces INNER JOIN categories ON categories.id_categories=annonces.id_categories WHERE annonces.id_categories = 3 ORDER BY annonces.date_publication DESC";
$rs = $db->prepare($sql);
$rs->execute();?>
<section>

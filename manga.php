...
<nav>
    <div class="logo">
        <a href="index_crud.php"><img src="style/images/goku.png" width="120px" alt="logo"/></a>
        <h1>Geek Avenue</h1>
    </div>
    <ul>
...
<?php
$sql = "SELECT * FROM annonces INNER JOIN categories ON categories.id_categories=annonces.id_categories WHERE annonces.id_categories = 2 ORDER BY annonces.date_publication DESC";
$rs = $db->prepare($sql);
$rs->execute();?>
<section>
